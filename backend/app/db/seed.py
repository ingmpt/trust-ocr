...
_GLOBAL_TEMPLATES = [
    {
        ...
        "field_definitions": [
            ...
            {"name": "numero_recibo", "label": "Número o código de recibo (identificador único impreso en el documento, distinto del N° de Suministro)"},
            ...
            {"name": "importe_total", "label": "Importe Total a Pagar (monto final que incluye el IGV; suele ser el monto más destacado del recibo)"},
            {"name": "subtotal", "label": "Subtotal antes de impuestos (monto base sin IGV; menor que el Importe Total)"},
    ...
    },
    {
        ...
        "field_definitions": [
            ...
            {"name": "razon_social_emisor", "label": "Razón Social / Proveedor"},
            {"name": "numero_suministro", "label": "N° de Suministro"},
            {"name": "numero_recibo", "label": "Número o código de recibo/pedido (identificador único impreso en el documento, distinto del N° de Suministro; si el recibo no muestra uno explícito, dejar null)"},
            {"name": "tipo_servicio", "label": "Tipo de Servicio"},
            {"name": "descripcion_servicio", "label": "Descripción del Servicio"},
            {"name": "importe_total", "label": "Total a Pagar (monto final que incluye el IGV; suele ser el monto más destacado del recibo)"},
            {"name": "subtotal", "label": "Subtotal antes de impuestos (monto base sin IGV; menor que el Total a Pagar)"},
            {"name": "fecha_vencimiento", "label": "Fecha de Vencimiento"},
            {"name": "fecha_emision", "label": "Fecha de Emisión"},
